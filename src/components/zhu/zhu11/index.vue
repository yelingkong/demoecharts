            ...
            areaStyle: {
              normal: {
                color: new this.$echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                  ...
                  {
                    offset: 1,
                    color: 'rgba(160, 57, 247, 0)'
                  }
                ], false),
              }
            },
            data: [600, 790, 900, 130, 600, 800, 800]
          },
          {
            name: '39-48',
            type: 'line',
            ...
            data: [460, 47, 40, 513, 560, 580, 570]
          },
          {
            name: '49-58',
            type: 'line',
            ...
            areaStyle: {
              normal: {
                color: new this.$echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                  ...
                  {
                    offset: 1,
                    color: 'rgba(253, 168, 57, 0)'
                  }
                ], false),
              }
            },
            data: [400, 490, 400, 530, 500, 500, 500]
          },
        ]
      }
      myChart.clear()
