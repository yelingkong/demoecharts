...
export class MyDoc {
   ...
   * @param style
   */
  addImage (data, width, height, styles) {
    this.counter++
   ...
   * @param style
   */
  addHyperlink (displayName, url, style) {
    this.counter++
