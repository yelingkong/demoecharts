export class JsZip {
    ...
    constructor(compression) {
        ...
        if (!this.compressions[this.compression]) {
    ...
    generate(asBytes) {
        ...
        return (asBytes) ? zip : this.encode(zip);
